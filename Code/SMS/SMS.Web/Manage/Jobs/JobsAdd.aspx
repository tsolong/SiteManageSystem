<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JobsAdd.aspx.cs" Inherits="SMS.Web.Manage.Jobs.JobsAdd" %>
        ...
        <form action="?action=add" method="post" onsubmit="return checkAdd();">
            ...
            <table class="addTab">
				...
				<tr>
					...
					<td><input type="text" name="Dept" id="Dept" class="txt" /></td>
                    <td class="rowMsg"><p><span class="required">*</span></p></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" name="Num" id="Num" class="txt" /></td>
                    <td class="rowMsg"><p><span class="required">*</span></p></td>
				</tr>
				<tr>
					<td><label for="Sex">性别要求：</label></td>
					<td><input type="text" name="Sex" id="Sex" class="txt" /></td>
                    <td class="rowMsg"><p><span class="required">*</span></p></td>
				</tr>
				<tr>
					<td><label for="Experience">工作年限：</label></td>
					<td><input type="text" name="Experience" id="Experience" class="txt" /></td>
                    <td class="rowMsg"><p><span class="required">*</span></p></td>
				</tr>
				<tr>
					<td><label for="Language">语言要求：</label></td>
					<td><input type="text" name="Language" id="Language" class="txt" /></td>
                    <td class="rowMsg"><p><span class="required">*</span></p></td>
				</tr>
				<tr>
					<td><label for="Salary">薪水范围：</label></td>
					<td><input type="text" name="Salary" id="Salary" class="txt" /></td>
                    <td class="rowMsg"><p><span class="required">*</span></p></td>
				</tr>
				<tr>
					<td><label for="Education">学历要求：</label></td>
					<td><input type="text" name="Education" id="Education" class="txt" /></td>
                    <td class="rowMsg"><p><span class="required">*</span></p></td>
				</tr>
				<tr>
					<td><label for="ResumeLanguage">简历语言：</label></td>
					<td><input type="text" name="ResumeLanguage" id="ResumeLanguage" class="txt" /></td>
                    <td class="rowMsg"><p><span class="required">*</span></p></td>
				</tr>
                <tr>
