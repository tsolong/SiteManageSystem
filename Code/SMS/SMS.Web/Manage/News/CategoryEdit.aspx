<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CategoryEdit.aspx.cs" Inherits="SMS.Web.Manage.News.CategoryEdit" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
        ...
        <form action="?action=save&id=<%=ID %>&p=<%=SMS.Common.Tools.GetQueryString("p") %>" method="post" onsubmit="return checkEdit();">
            ...
            <table class="editTab">
                <tr>
                    ...
                    <td><input type="text" id="CategoryName" name="CategoryName" class="txt" value="<%=NewsCategory.CategoryName %>" /></td>
                    <td class="rowMsg"><p><span class="required">*</span> 分类名称最大长度是10个字。</p></td>
                </tr>
                <tr>
                    <th><label for="OrderID">分类排序：</label></th>
                    <td><input type="text" id="OrderID" name="OrderID" class="txt" value="<%=NewsCategory.OrderID %>" /></td>
